...
train_data = "/home/ubuntu/Documents/DRBox/data/bottle/train_data/bottle/lmdb/bottle_trainval_lmdb"
...
job_name = "RBOX_{}_BOTTLEOPT_VGG".format(resize)
# The name of the model. Modify it if you want.
model_name = "RBOX_BOTTLEOPT_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/RBOX/bottle/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/RBOX/bottle/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/RBOX/bottle/{}".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/data/bottle/results/RBOX/{}/Main".format(os.environ['HOME'], job_name)
